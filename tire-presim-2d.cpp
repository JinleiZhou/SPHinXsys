...
Real Youngs_modulus = 1e5;//20-80MPa
Real poisson = 0.45;
...
class CarweightForce : public ForcePrior
{
  protected:
  ...
  public:
    CarweightForce(BodyRegionByParticle&sph_body,const CarweightForcetype &gravity);
